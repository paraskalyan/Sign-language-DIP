...
# classifier.add(Convolution2D(128, (3, 3), input_shape=(300, 300, 3), activation='relu'))
# classifier.add(MaxPooling2D(pool_size=(2, 2)))
# classifier.add(Dropout(0.25))
...
classifier.fit_generator(
        training_set,
        steps_per_epoch=12690, # No of images in training set
        epochs=10,
        validation_data=test_set,
        validation_steps=4212)# No of images in test set
